...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Bitter:400,700,400italic,700italic" rel="stylesheet"
        type="text/css" />
    <!--<![endif]-->
    <style type="text/css">
        .main,
        ...
        .mso .layout-has-border {
            border-top: 1px solid #85e1aa;
            border-bottom: 1px solid #85e1aa
        }
