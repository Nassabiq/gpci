...
@section('content')
    <table class="wrapper"
        style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #d7f5e3;"
                        ...
                        <div class="header"
                            ...
                            <div class="logo emb-logo-margin-box"
                                ...
                                <div class="logo-center" align="center" id="emb-email-header"><img
                                        ...
                                        src="{{ $message->embed('img/GPCI-Logo.png') }}" alt="" width="141" /></div>
                            </div>
                            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                        </div>
                    </div>
                    <div>
                        <div class="layout one-col fixed-width stack"
                            ...
                            <div class="layout__inner"
                                style="border-collapse: collapse;display: table;width: 100%;background-color: #19a9e5;">
                                ...
                                <div class="column"
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div
                                            ...
                                            <h1 class="size-24"
                                                style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #000;font-size: 20px;line-height: 28px;font-family: bitter,georgia,serif;text-align: center;"
                                                lang="x-size-24">
                                ...
                                <div class="column"
                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div
                                            style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                            <p class="size-16"
                                                style="Margin-top: 0;Margin-bottom: 0;font-family: bitter,georgia,serif;font-size: 16px;line-height: 24px;text-align: center;"
                                                lang="x-size-16">
                                                <span class="font-bitter">
                                            ...
                                            <p class="size-16"
                                                ...
                                                lang="x-size-16">
                                                <span class="font-bitter">
                                                    <span style="color:#000000">Dokumen Pelengkap Perusahaan Sesuai dengan
                                                        Checklist Dokumen Produk Terkait dapat diakses</span>
                                                    <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #18527c;"
                                                        href="{{ route('approve-dokumen') }}">
                                                        <span style="color:#085382">disini</span>
                                                    </a>
                                                </span>
                                            </p>
                                            <p class="size-16"
                                                style="Margin-top: 20px;Margin-bottom: 20px;font-family: bitter,georgia,serif;font-size: 16px;line-height: 24px;text-align: center;"
                                                lang="x-size-16">
                                                <span class="font-bitter">
                                                    <span style="color:#000000">Demikian informasi dari kami. Terima kasih
                                                        atas perhatiannya.
                                                    </span>
                                                </span>
                                            </p>
